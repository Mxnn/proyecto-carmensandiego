...
public class IntegradoresTest {
	@Test
	public void policiaDeRangoNovatoViajaATresPaisesYAtrapaAlLadronEmitiendoOrdenDeArrestoPrevia() throws ExcepcionTiempoAgotado {
		...
		policia.arrestarA(unLadron);

		Assert.assertTrue(unLadron.estaArrestado() && unLadron.tieneOrdenDeArresto());
	}

    @Test 
    public void policiaDeRangoDetectiveViajaATresPaisesYNoAtrapaAlLadron() throws ExcepcionTiempoAgotado {
        Ciudad buenosAires = new Ciudad("Buenos Aires", new Coordenada(-3000.0, -9000.0));
        Ciudad londres = new Ciudad("Londres", new Coordenada(-3000.0, -9000.0));
        Ciudad reykjavic = new Ciudad("Reykjavic", new Coordenada(-3000.0, -9000.0));
        Ciudad tokio = new Ciudad("Tokio", new Coordenada(9000.0, 1500.0));
		...
		Assert.assertFalse(unLadron.estaArrestado() && unLadron.tieneOrdenDeArresto());
    }

    @Test(expected = ExcepcionTiempoAgotado.class)
    public void policiaDeRangoSargentoViajaPorLosPaisesYSeQuedaSinTiempo() throws ExcepcionTiempoAgotado {
    ...
    @Test
    public void casoPruebaGrupo1AtrapaAlLadron() throws ExcepcionTiempoAgotado {
        Ciudad buenosAires = new Ciudad("Buenos Aires", new Coordenada(-3000.0, -9000.0));
        Ciudad londres = new Ciudad("Londres", new Coordenada(-3000.0, -9000.0));
    ...
    @Test(expected = ExcepcionTiempoAgotado.class)
    public void casoPruebaGrupo1NoAtrapaAlLadronYSeQuedaSinTiempo() throws ExcepcionTiempoAgotado {
    ...
    @Test
    public void casoPruebaGrupo2ElLadronEsAtrapado() throws ExcepcionTiempoAgotado {
    ...
    @Test
    public void casoPruebaGrupo2NoAtrapaAlLadronPorEmitirMalLaOrdenDeArresto() throws ExcepcionTiempoAgotado {
        Ciudad buenosAires = new Ciudad("Buenos Aires", new Coordenada(1, 1));
        Ciudad hongKong = new Ciudad("Hong Kong", new Coordenada(2, 2));
        Ciudad tokio = new Ciudad("Tokio", new Coordenada(5, 5));
        Ciudad londres = new Ciudad("Londres", new Coordenada(20, 20));
        Policia policia = new Policia("Esteban");
		policia.setCiudadActual(buenosAires);
        ...
        Assert.assertFalse(ladron.estaArrestado() && ladron.tieneOrdenDeArresto());
    }

    @Test
    public void casoPruebaGrupo4ElLadronEsAtrapado() throws ExcepcionTiempoAgotado {
        Ciudad paris = new Ciudad("Paris", new Coordenada(1, 1));
        Ciudad londres = new Ciudad("Londres", new Coordenada(2, 2));
        Ciudad buenosAires = new Ciudad("Buenos Aires", new Coordenada(3, 3));
    ...
    @Test(expected = ExcepcionTiempoAgotado.class)
    public void casoPruebaGrupo5NoAtrapaAlLadronPorQuedarseSinTiempo() throws ExcepcionTiempoAgotado {
